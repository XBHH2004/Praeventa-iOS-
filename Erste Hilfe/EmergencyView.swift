...
struct EmergencyView: View {
    ...
    @Binding var isEmergencyMode: Bool

    init(isEmergencyMode: Binding<Bool> = .constant(false)) {
        self._isEmergencyMode = isEmergencyMode
    }
...
cd ~/Desktop/PRAEVENTA/"Erste Hilfe"
cat > "Erste Hilfe/EmergencyView.swift" <<'EOF'
import SwiftUI
